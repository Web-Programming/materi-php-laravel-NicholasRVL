        ...
        <div class="card-body register-card-body " style="background-color: rgb(121, 121, 121);">
          ...
          <form action="{{ url('register') }}" method="post">
            ...
            <div class="input-group mb-1">
              ...
              <div class="input-group-text" style="color: rgb(219, 219, 196);"><span class="bi bi-person"></span></div>
            </div>
            @error('name')
            ...
            <div class="row">
              ...
              <div class="col-4">
                <div class="d-grid gap-2">
                  <button type="submit" class="btn" style="background-color: rgb(219, 219, 196);">Sign Up</button>
                </div>
              </div>
              <!-- /.col -->
            </div>
